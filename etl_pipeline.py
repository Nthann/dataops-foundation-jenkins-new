...
def create_star_schema(df):
    ...
    if 'home_ownership' in df.columns:
        ...
        dim_tables['home_ownership_dim_mada'] = home_ownership_dim
    ...
    if 'loan_status' in df.columns:
        ...
        dim_tables['loan_status_dim_mada'] = loan_status_dim
    ...
    if 'issue_d' in df.columns:
        ...
        dim_tables['issue_d_dim_mada'] = issue_d_dim
...
def deploy_to_database(fact_table, dim_tables):
    ...
    try:
        ...
        fact_table.to_sql('loans_fact_mada', con=engine, if_exists='replace', index=False)
        ...
        with engine.connect() as connection:
            for table_name in list(dim_tables.keys()) + ['loans_fact_mada']:
